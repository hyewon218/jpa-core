...
public class PersistenceTest {
    ...
    @BeforeEach
        // 각각의 메서드가 실행하기 전에 먼저 실행됨
    void setUp() {
        // /resources/META-INF/  위치에 persistence.xml 의 유닛 이름
    ...
    void test4() {
        ...
        try {
            ...
            Memo memo1 = em.find(Memo.class, 1); // select 날아감
            Memo memo2 = em.find(Memo.class, 1); // select 안 날아감
            Memo memo = em.find(Memo.class, 2);

            System.out.println(memo1 == memo2); // true(1차 캐시에 있는 값을 동일하게 받아 옴 - 동일성 보장)
